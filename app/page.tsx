                    ...
                    <div className="col-xl-6 col-lg-7 col-md-12">
                      <div className="hero__caption">
                        ...
                        <p data-animation="fadeInLeft" data-delay="0.4s">
                          Build skills with courses, certificates, and degrees online from world-class universities and
                          companies.
                        </p>
                  ...
                  <div key={topic} className="col-lg-3 col-md-4 col-sm-6">
                    <div className="single-topic text-center mb-30">
                      <div className="topic-img">
                        <img src={`/assets/img/gallery/topic${topic}.png`} alt={`Topic ${topic}`} />
        ...
        <section className="about-area3 fix">
            <div className="support-wrapper align-items-center">
                ...
                <div className="left-content3">
                    ...
                    <div className="single-features">N
                        <div className="features-icon">
                            <img src="assets/img/icon/right-icon.svg" alt=""/>
                        </div>
                        <div className="features-caption">
